...
// TODO: 2. Handle all buttons (prev, later, x)
// TODO: 3. Handle classes in css such as showPrevBtn to know when buttons should appear and when not.
                    ...
                    <div class="showLaterBt">
                        <div class="stFooter" data-iridize-id="footer">
                            <div>
                                ...
                                <!-- Later -->
                                <button onclick="handleLater()" tabindex="999" class="later-btn " data-iridize-role="laterBt">Remind me later</button>
                                <span class="powered-by">Powered by </span>
                            </div>
                            <div data-iridize-role="nextBtPane">
                                <!-- Prev -->
                                <button onclick="handlePrev()" tabindex="999" class="prev-btn " data-iridize-role="prevBt">Back</button>
                                <!-- Next -->
